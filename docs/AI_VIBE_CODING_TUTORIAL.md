...
这是一套面向非技术用户的 12 步教程。你只需要准备按顺序要去的地点，以及每一站要揭晓的礼物或体验；Codex 会继续完成地点核验、坐标转换、真实步行路线查询、地图分组、文案、配置与测试。

![12 张教程图总览](tutorial/00-preview-grid.png)
...
它是一种纪念日惊喜策划方式：生日、周年或其他重要日子都可以使用。TA 会跟着《哈利·波特》式活点地图寻找你设置的地点，抵达后才触发礼物、约会、晚餐或其他惊喜内容，在当天完整经历寻找、抵达和发现。
...
> 封面中的公开传播数据截图由项目作者提供并授权用于本仓库；教程中的 Codex 对话界面为根据真实操作流程制作的隐私安全复刻。
